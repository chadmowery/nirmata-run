...
```bash
PHASE_INFO=$(node "/Users/chadmowery/personal/dev/dungeon-runner/nimrata-run/.gemini/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}")
```
...
```bash
PHASE_CHECK=$(node "/Users/chadmowery/personal/dev/dungeon-runner/nimrata-run/.gemini/get-shit-done/bin/gsd-tools.cjs" roadmap get-phase "${PHASE}" --pick found)
...
```bash
PHASE_DIR=$(node "/Users/chadmowery/personal/dev/dungeon-runner/nimrata-run/.gemini/get-shit-done/bin/gsd-tools.cjs" find-phase "${PHASE}" --raw)
```
