...
<!-- For checkpoint task examples and patterns, see @/Users/chadmowery/personal/dev/dungeon-runner/nimrata-run/.gemini/get-shit-done/references/checkpoints.md -->
...
See `/Users/chadmowery/personal/dev/dungeon-runner/nimrata-run/.gemini/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `/Users/chadmowery/personal/dev/dungeon-runner/nimrata-run/.gemini/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `/Users/chadmowery/personal/dev/dungeon-runner/nimrata-run/.gemini/get-shit-done/workflows/verify-phase.md` for verification logic.
