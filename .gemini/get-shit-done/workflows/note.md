...
- **Global scope**: `/Users/chadmowery/personal/dev/dungeon-runner/nimrata-run/.gemini/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/chadmowery/personal/dev/dungeon-runner/nimrata-run/.gemini/notes/`)
...
2. Glob `/Users/chadmowery/personal/dev/dungeon-runner/nimrata-run/.gemini/notes/*.md` (if directory exists) — global notes
...
Global (/Users/chadmowery/personal/dev/dungeon-runner/nimrata-run/.gemini/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/chadmowery/personal/dev/dungeon-runner/nimrata-run/.gemini/notes/` — works in any directory
