...
See /Users/chadmowery/personal/dev/dungeon-runner/nimrata-run/.gemini/get-shit-done/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using /Users/chadmowery/personal/dev/dungeon-runner/nimrata-run/.gemini/get-shit-done/templates/discovery.md structure:
...
1. **Scope the discovery** using /Users/chadmowery/personal/dev/dungeon-runner/nimrata-run/.gemini/get-shit-done/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from /Users/chadmowery/personal/dev/dungeon-runner/nimrata-run/.gemini/get-shit-done/templates/discovery.md
...
Use /Users/chadmowery/personal/dev/dungeon-runner/nimrata-run/.gemini/get-shit-done/templates/discovery.md.
